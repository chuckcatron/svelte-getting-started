...
<p class="greeting">This is a library for the people. Welcome. Read the book here. Be inspired. Go home, and share them with you family.</p>

<Button to="/create">+ Add Book</Button>

<BookGrid {books} on:book-select></BookGrid>
